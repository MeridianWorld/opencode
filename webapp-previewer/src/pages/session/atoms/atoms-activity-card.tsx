...
export function AtomsActivityCard(props: { row: Extract<AtomsRow, { kind: "activity" }> }) {
  return (
    <article class="max-w-[40rem] rounded-[24px] border border-[var(--atoms-line)] bg-[var(--atoms-card-muted)] px-4 py-3 text-[var(--atoms-soft)] shadow-[var(--atoms-shadow-soft)]">
      <div class="text-[11px] font-semibold uppercase tracking-[0.16em]">Activity</div>
